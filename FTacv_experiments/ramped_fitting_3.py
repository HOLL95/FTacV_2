...
for j in range(3, 7, 1):
    ...
    ramp_fit.def_optim_list(["E0_mean", "E0_std","k_0" ,"Ru","Cdl","CdlE1", "CdlE2","gamma",'omega', "alpha_mean", "alpha_std"])
    ...
    for i in range(0, num_runs):
        ...
        noramp_params=[0.22925918516708654, 0.04595696579195954, 180.33007397100599, 873.5412252656006, 3.3412012933121965e-05, 0.057928207116134806, -0.0021217096115628917, 7.178042062464878e-11, 8.884751771027027, 0.43751189633466997, 0.17]
