...
for i in range(1,8):
            ...
            #means=means4_8
            test=noramp_fit.simulate(mad_means,frequencies, "no", "timeseries", "no" )
            plt.plot(test)
            ...
            data_peaks=harm_class.generate_harmonics(time_results, current_results, peaks=True)
            exp_peaks=harm_class.generate_harmonics(time_results, test, peaks=True)
