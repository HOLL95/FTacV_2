...
optim_list=["",'E0_mean', "E0_std","k_0","Ru", "Cdl","CdlE1","CdlE2", "gamma"]
name_list=[fancy_names[x] for x in optim_list]
values=[[0.33898493181354783, 0.04831498816063667,50, 217.73098186685877, 9.999999999521779e-05, 0.328169823202771, -0.0051563848579775085, 3.2407951142111226e-11],\
        ]
names=["DcV\ Carbon\ dispersion"]
