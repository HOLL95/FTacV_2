...
means=[2.32925736e-01, 40.0, 2.85485831e+02, 3.71093751e-04, 1.35701508e-10, 8.94069113e+00]
...
print cmaes_results
cmaes_time_prediction=ramp_fit.simulate(found_parameters,frequencies, "optimise", "timeseries", "no" )
cmaes_prediction=ramp_fit.simulate(found_parameters,frequencies, "optimise", "fourier", "no" )
