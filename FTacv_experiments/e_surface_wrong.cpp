...
py::object martin_surface(double Cdl, double CdlE, double CdlE2, double CdlE3,double omega,double v,double alpha ,double Estart, double Ereverse, \
	double delta_E, double Ru, double dt,  std::vector<double> t, double gamma, double E0, double k0, double phase, double pi, int num_points, double initial_val) {
