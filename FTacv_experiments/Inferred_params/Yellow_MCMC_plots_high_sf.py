...
#f=open(filename, "r")
params1=["E0_mean", "E0_std", "k_0","Ru","Cdl","CdlE1", "CdlE2","gamma","omega","cap_phase","phase", "noise"]
params=["E0_mean", "E0_std", "k_0","Ru","Cdl","CdlE1", "CdlE2","gamma","omega","cap_phase","phase", "alpha_mean", "alpha_std", "noise"]
...
chains=np.load(("/").join([electrode, folder, "Noramp_9_cv_high_ru_alpha_disp_MCMC_run_25"]))
