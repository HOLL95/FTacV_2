...
values=[[0.24116928285797873, 0.044189985533550226, 135.53440184454033, 510.6019261842285, 7.57155256924869e-05, 0.001459719577206274, -0.00037125091413634306, 7.200978526571967e-11, 8.884799587792013, 0, 0.5973834903322666, ],
        [0.22925918516708654, 0.04595696579195954, 123.33007397100599, 873.5412252656006, 3.3412012933121965e-05, 0.057928207116134806, -0.0021217096115628917, 7.178042062464878e-11, 8.884751771027027, 0,0.43751189633466997]]
...
for i in range(0, 2):
    ...
    for harm_counter in range(0, len(ramped_harmonics),1):
        ...
        ax.plot(ramped_time_results, (ramped_harmonics[harm_counter,:]*1e6), label="Sim")
