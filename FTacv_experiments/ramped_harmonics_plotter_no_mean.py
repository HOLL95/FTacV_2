...
values=[[0.24323038307184336, 0.58906941878404, 55.76171519515906, 672.7221187164696, 7.764498276243975e-05, 0.002120925983914189, -0.000384743271809684, 7.697386442097152e-11, 8.940520091009153, 4.419395313633473, 5.104001442412966, 0.5622531162206027]
]
...
for i in range(0, 100):
    ramped_time_series=ramp_fit.i_nondim(ramp_fit.test_vals(values, "timeseries"))
