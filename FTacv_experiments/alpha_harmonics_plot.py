...
num_harms=7
figure=multiplot(num_rows=1, num_cols=1, **{"harmonic_position":[0], "num_harmonics":num_harms, "orientation":"landscape",  "plot_width":5})
...
for j in range(len(plot_params)-1, len(plot_params)):
