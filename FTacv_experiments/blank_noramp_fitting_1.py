...
path=("/").join([dir_path, data_path, Experiment, folder])
...
blank_fit.def_optim_list(["Ru","Cdl","CdlE1","cap_phase"])
inferred_params=[4.3683130078899973e-07, 1.8451434663645934e-05, -0.006241730444101798, 4.392504086957556]
plt.plot(voltage_results, current_results)
for i in [0, 10, 200, 300]:
    inferred_params[0]=i
    time_series=blank_fit.test_vals(inferred_params, "timeseries")
    plt.plot(voltage_results, time_series, alpha=0.5)
plt.show()
