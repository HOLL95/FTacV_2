...
class single_electron:
    ...
    def simulate(self,parameters, frequencies, flag='optimise', flag2='fourier', test="no"):
        ...
        time_series=isolver_ramped.e_surface(self.nd_param.Cdl,self.nd_param.CdlE1,self.nd_param.CdlE2,self.nd_param.CdlE3,self.nd_param.nd_omega,1, self.nd_param.alpha , \
                                    self.nd_param.E_start,  self.nd_param.E_reverse,  self.nd_param.d_E,  self.nd_param.Ru,200, self.time_vec,  self.nd_param.gamma, \
                                     self.nd_param.E_0, self.nd_param.k_0, self.nd_param.phase, math.pi, self.num_points, self.secret_data_time_series[0])
