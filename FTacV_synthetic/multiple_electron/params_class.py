...
class params:
    def e0(self, value, flag):
        if flag=='re_dim':
            self.E_0=np.multiply(value,self.c_E0)
        elif flag == 'non_dim':
            self.E_0=np.divide(value,self.c_E0)
    def k0(self, value, flag):
        if flag=='re_dim':
            self.k_0=np.divide(value,self.c_T0)
        elif flag == 'non_dim':
            self.k_0=np.multiply(value,self.c_T0)
    ...
    def __init__(self,param_dict):
        ...
        self.num_species=param_dict['num_species']
        self.T=(273+25)
