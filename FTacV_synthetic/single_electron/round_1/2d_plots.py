...
chains_5000=np.load("5000_k")
chains_5000_2=np.load("5000_k_2")
titles=['E_0', 'k_0', 'Cdl', 'Ru']
true_params=[-0.4, 5000, 0.000133878548046,20.0]
n_param=len(titles)
chains=chains_5000_2
chain_select=2
fig_size=(12,12)
...
for i in range(0,n_param):
    for j in range(0, n_param):
        if i==j:
            ...
            plot_kde_1d(chains[chain_select, 5000:, j], ax=axes)
            ...
            plot_kde_2d(chains[chain_select, 5000:, j], chains[chain_select, 5000:, i], ax=axes)
